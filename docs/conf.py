...
latex_documents = [
  ('index', 'pypinyin.tex', 'pypinyin Documentation',
   'mozillazg', 'manual'),
]
...
man_pages = [
    ('index', 'pypinyin', 'pypinyin Documentation',
     ['mozillazg'], 1)
]
...
texinfo_documents = [
  ('index', 'pypinyin', 'pypinyin Documentation',
   'mozillazg', 'pypinyin', 'One line description of project.',
   'Miscellaneous'),
]
