...
def test_neutral_tone_with_5():
    ...
    assert lazy_pinyin(
        '好了', neutral_tone_with_five=True, v_to_u=True,
        tone_sandhi=True) == ['hao', 'le']
    assert lazy_pinyin(
...
def test_neutral_tone_with_5_many_cases(
